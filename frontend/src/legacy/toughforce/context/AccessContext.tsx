...
const PROFILE_SELECTS = [
  'id, full_name, role, email, avatar_url, company_id, company_code, organization_id, module, login_scope, dashboard_access',
  'id, full_name, role, email, avatar_url, company_id, company_code, organization_id, module, login_scope',
  'id, full_name, role, email, avatar_url, company_id, company_code, organization_id, module',
  'id, full_name, role, email, avatar_url, company_id, company_code, organization_id',
  'id, full_name, role, email, avatar_url, company_id, company_code',
  'id, full_name, role, email, avatar_url, company_id',
  'id, full_name, role, email, avatar_url',
] as const;
  ...
  const fetchPermissions = useCallback(async (skipLoading = false, providedSession?: any) => {
    ...
    try {
      ...
      for (const fields of PROFILE_SELECTS) {
        const attempt = await supabase.from('profiles').select(fields).eq('id', user.id).maybeSingle();
