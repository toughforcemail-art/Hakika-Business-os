...
export default function Login() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    if (loading) return;
    setError("");
    const value = identifierRef.current?.value.trim() ?? "";
